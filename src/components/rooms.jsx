            ...
            <main className='mx-10 my-5 py-5 bg-teal-950/60 text-neutral-300 tracking-widest leading-loose ransition-opacity duration-700 ease-out opacity-0 animate-[fadeIn_0.8s_ease-out_forwards]'>
                ...
                <CardLeft title='ROOMS' images={roomsList} >
                            <p className='mb-5  '>Nestled in the heart of nature, Pucté is a tranquil retreat where timeless
                                ...
                                {isExpanded ? '' : (
                                    <button className='border-1 rounded p-2' {...getToggleProps()}>Show More</button>
                                )}
                             <section className='mb-5' {...getCollapseProps()}>
                            ...
                            {isExpanded ? (
                             <button className='border-1 rounded p-2' {...getToggleProps()}>Show Less</button>
                            ) : ''}   
                </CardLeft>
