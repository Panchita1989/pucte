...
export default function Bacalar() {
    return(
        ...
        <section className='mx-20 my-1 py-5 bg-teal-950/80 text-neutral-300 tracking-widest leading-loose'>
            <NavBar />
            <CardLeft title='BACALAR' img='src/assets/images/bacalar1.jpg' >
            ...
            <CardRight title='FOOD' img='src/assets/images/food.jpg'>
            ...
            <CardLeft title='Time for a drink' img='src/assets/images/drinks.jpg'>
            ...
            <CardRight title='Water is everywhere and is everything' img='src/assets/images/water.webp'>
            ...
            <CardLeft title='OUR PAST' img='src/assets/images/past.webp'>
